...
namespace BobAndLenny
{
    internal class Guy
    {
        ...
        /// to the console if i do not have enough cash).
        /// </summary>
        ...
        /// <summary>
        /// Receive some cash, adding it to my wallet (or printing a message
        ...
        public void ReceiveCash(int amount) {
            if (amount <= 0)
            {
                Console.WriteLine($"{Name} says: {amount} is not an amount I'll take");
            }
            else
            {
                Cash += amount;
